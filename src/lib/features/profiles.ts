...
const allFlags = (value: boolean) =>
  ({
    ...
    pilot_simplicity_mode: value,
    game_day_minimal_mode: value,
    required_fields_only_entry: value,
    pilot_settings_scoped_storage: value,
    pilot_settings_server_sync: value,
